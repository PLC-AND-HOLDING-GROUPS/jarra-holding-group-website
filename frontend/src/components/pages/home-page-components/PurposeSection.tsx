...
import { Globe2, Handshake, TrendingUp, Users } from "lucide-react";
        ...
        <section className="w-full bg-slate-50 py-24 md:py-32 relative overflow-hidden">
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        ...
                        <div className="absolute -bottom-10 -left-6 md:-left-12 lg:-left-16 bg-white p-6 md:p-8 rounded-xl shadow-xl border border-slate-100 max-w-[280px] md:max-w-[320px] z-20">
                            ...
                            <p className="text-lg md:text-xl font-bold text-slate-900 leading-snug">
                                "Delivering innovative and sustainable solutions across industries."
                            </p>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 mt-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    {/* Pillar 1 */}
                    <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md border border-slate-100 transition-all group">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3">Sustainable Investment</h3>
                        <p className="text-slate-600 leading-relaxed">
                            Investing in sustainable business portfolios that create long-term value.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md border border-slate-100 transition-all group">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3">Economic Empowerment</h3>
                        <p className="text-slate-600 leading-relaxed">
                            Supporting economic participation and creating opportunities for citizens and communities.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md border border-slate-100 transition-all group">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3">Market Development</h3>
                        <p className="text-slate-600 leading-relaxed">
                            Helping address market gaps while connecting products, businesses, and customers.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md border border-slate-100 transition-all group">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3">Shared Growth</h3>
                        <p className="text-slate-600 leading-relaxed">
                            Creating value for shareholders while contributing to national socio-economic development.
                        </p>
                    </div>
