...
export default function ProductCard({ product }: { product: Product }) {
    ...
    // Use main image or first attachment or fallback
    const mainImage = product.attachments?.find(a => a.category === "main")?.attachment?.url 
        || product.attachments?.[0]?.attachment?.url 
        || "/placeholder.jpg"; // Use a real placeholder if needed
