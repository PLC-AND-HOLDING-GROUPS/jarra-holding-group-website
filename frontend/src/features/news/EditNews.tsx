            ...
            <div className="bg-card text-card-foreground p-6 rounded-lg shadow overflow-y-auto space-y-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <EditFileUpload
                        ...
                        showPreview
                        category="headline"
                        onDelete={(attachmentId: string) => handleDeleteAttachment(attachmentId, 'headline')}
                    />
                    ...
                    <EditFileUpload
                        ...
                        showPreview
                        category="footer"
                        onDelete={(attachmentId: string) => handleDeleteAttachment(attachmentId, 'footer')}
                    />
